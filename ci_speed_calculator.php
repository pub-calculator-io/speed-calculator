...
Version: 1.0.0
Author: Speed Calculator / www.calculator.io
...
if (!function_exists('add_shortcode')) return "No direct call for Speed Calculator by www.calculator.io";

function display_calcio_ci_speed_calculator(){
    $page = 'index.html';
...
add_shortcode( 'ci_speed_calculator', 'display_calcio_ci_speed_calculator' );